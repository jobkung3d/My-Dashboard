            ...
            <div className="flex-grow">
                <div className="container mx-auto shadow0xl my-10 p-10 rounded-xl">
                    ...
                    <form action="" onSubmit={handleSubmit}>
                        ...
                        <input type="text" onChange={(e) => setImg(e.target.value)} className="w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2" placeholder='Img url' />
                        <textarea onChange={(e) => setContent(e.target.value)} cols="30" rows="10" className="w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2" placeholder='Enter your post content'>
